...
public class MatrizDispersa {
    public void graficarMatriz(Matriz matriz){
        try{
            if(matriz != null){
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("Matriz.txt", false))) {
                    ...
                    while(tmpF != null){
                        ...
                        while(tmpCelda != null){
                            celdas += "x"+tmpCelda.numColumna+"y"+tmpCelda.numFila+" [ label = \""+tmpCelda.valor.toString()+"\\n "+tmpCelda.contador+"\" group = "+(tmpCelda.numColumna+1)+" ];\n";
        ...
        }catch(Exception ex){sistema.ui.VentanaConfiguracion.txtLog.append("Error Graficando Matriz...\n");}
    }
